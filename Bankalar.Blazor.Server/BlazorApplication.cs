...
namespace Bankalar.Blazor.Server {
    public partial class BankalarBlazorApplication : BlazorApplication {
        public BankalarBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void BankalarBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
